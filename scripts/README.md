...
2. `deploy-infra.sh` — create/update the Azure app/agent resource group after `what-if` review; by default it reuses the existing UC3 Databricks workspace instead of creating a new one.
