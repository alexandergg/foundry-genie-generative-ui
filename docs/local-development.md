...
- `.foundry/agent-metadata.yaml` present. It is generated by `scripts/60-setup-foundry-genie-agent.sh` or can be created from `.foundry/agent-metadata.example.yaml`.
