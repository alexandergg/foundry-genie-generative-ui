...
def test_extract_collects_dataset_and_visuals() -> None:
    messages = [
        ...
        _ai_tool_call("cacheDataset", {"id": "ds-1", "title": "Exposure", "columns": [{"key": "Country", "role": "dimension"}, {"key": "Exposure", "role": "measure"}], "rows": []}),
        _ai_tool_call("addVisual", {"datasetId": "ds-1", "type": "barChartCard", "dimension": "Country", "measure": "Exposure", "title": "Bar"}),
        _ai_tool_call("addVisual", {"datasetId": "ds-1", "type": "donutChartCard", "dimension": "Country", "measure": "Exposure", "title": "Donut"}),
    ]
